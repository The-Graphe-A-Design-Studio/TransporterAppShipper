                  ...
                  .map((e) => Container(
                        ...
                        child: Column(
                          ...
                          children: [
                                        ...
                                        .map(
                                          (t) => Column(
                                            ...
                                            children: [
                                              ...
                                              if (e.deliveryTrucks.indexOf(t) !=
                                                  e.deliveryTrucks.length - 1)
                            ...
                            if ((e.modeName == 'Advance Pay' ||
                                    e.modeName == 'Pay full after unloading') &&
                                e.payment['remaining amount']['status'] == '0')
                              SizedBox(height: 20.0),
                            if ((e.modeName == 'Advance Pay' ||
                                    e.modeName == 'Pay full after unloading') &&
                                e.payment['remaining amount']['status'] == '0')
                                  ...
                                  RaisedButton(
                                    ...
                                    onPressed: () {
                                      ...
                                      HTTPHandler()
                                        ...
                                        e.payment['remaining amount']['pay id'],
                                      )
                                          .then((value) async {
                                        Navigator.of(context).pop();
                                        if (value.success) {
                            ...
                            if ((e.modeName == 'Advance Pay' ||
                                    e.modeName == 'Pay full after unloading') &&
                                e.payment['remaining amount']['status'] == '1')
                              SizedBox(height: 20.0),
                            if ((e.modeName == 'Advance Pay' ||
                                    e.modeName == 'Pay full after unloading') &&
                                e.payment['remaining amount']['status'] == '1')
